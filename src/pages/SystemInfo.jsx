...
export default function SystemInfo() {
    const infoCards = [
        { icon: Shield, label: 'System Version', value: systemInfo.version, gradient: 'gradient-blue' },
        { icon: Cpu, label: 'AI Model', value: systemInfo.aiModel, gradient: 'gradient-purple' },
        { icon: Clock, label: 'Uptime', value: systemInfo.uptime, gradient: 'gradient-green' },
        { icon: RefreshCw, label: 'Last Sync', value: systemInfo.lastSync, gradient: 'gradient-yellow' },
        { icon: Activity, label: 'Detection Mode', value: systemInfo.detectionMode, gradient: 'gradient-blue' },
        { icon: Gauge, label: 'Frame Rate', value: systemInfo.frameRate, gradient: 'gradient-green' },
    ];
    ...
    return (
        <div className="space-y-6">
                ...
                {infoCards.map((card, i) => (
                    ...
                    >
                        <div className="flex items-center gap-5">
                            <div
                                className={`w-12 h-12 rounded-xl ${card.gradient} flex items-center justify-center shrink-0 shadow-lg`}
                            >
            ...
            {/* Storage */}
            <div className="glass-card p-7 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
            ...
            {/* Disclaimer */}
            <div className="glass-card p-7 border-l-4 border-l-accent-yellow animate-fade-in-up" style={{ animationDelay: '600ms' }}>
